"""
Created on 2023-04-14 17:35:16
---------
@summary: 爬虫入口
---------
@author: xue
...
from spiders import *
from spiders.spider_test import SpiderTest
...
def _baidu_spider2():
    SpiderTest(thread_count=10, redis_key="baidu_spider").start()
...
if __name__ == "__main__":
    ...
    # parser.add_argument(
    #     "--spider-project", action="store_true", help="轻量爬虫", function=SpiderTest
    # )
    parser.add_argument(
